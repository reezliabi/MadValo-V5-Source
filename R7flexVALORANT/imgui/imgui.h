...
namespace ImGui
{
    ...
    IMGUI_API bool          ButtonKU(const char* label, const ImVec2& size = ImVec2(0,0));    // button
    IMGUI_API bool          Buttonsac(const char* label, const ImVec2& size = ImVec2(0,0));    // button
    IMGUI_API bool          sukar(const char* label, const ImVec2& size = ImVec2(0,0));    // button
    IMGUI_API bool          Buttonn(const char* label, const ImVec2& size = ImVec2(0,0));    // button
    IMGUI_API bool          ButtonExitt(const char* label, const ImVec2& size = ImVec2(0,0));    // button
    IMGUI_API bool          ButtonExittn(const char* label, const ImVec2& size = ImVec2(0,0));    // button
    IMGUI_API bool          ButtonIconn(const char* label, const ImVec2& size = ImVec2(0,0));    // button
    ...
    IMGUI_API bool          SliderScalarr(const char* label, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format = NULL, float power = 1.0f);
